...
def test(model, user_dict, n_params):
    global n_users,n_items,train_user_set,test_user_set
    ...
    for u_batch_id in range(n_user_batchs):
        ...
        # print(user_batch_rating_uid)
        # test1()
        partial_test_one_user = partial(test_one_user, train_user_set=train_user_set, test_user_set=test_user_set,n_items = n_items)
